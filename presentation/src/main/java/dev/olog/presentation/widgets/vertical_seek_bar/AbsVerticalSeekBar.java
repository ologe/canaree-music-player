...
public class AbsVerticalSeekBar extends VerticalProgressBar{
    ...
    public AbsVerticalSeekBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.VerticalSeekBar, defStyle, 0);
        Drawable thumb = a.getDrawable(R.styleable.VerticalSeekBar_android_thumb);
        setThumb(thumb); // will guess mThumbOffset if thumb != null...
        // ...but allow layout to override this
        int thumbOffset =
                a.getDimensionPixelOffset(R.styleable.VerticalSeekBar_android_thumbOffset, getThumbOffset());
        setThumbOffset(thumbOffset);
        a.recycle();

        a = context.obtainStyledAttributes(attrs,
                R.styleable.VerticalTheme, 0, 0);
        mDisabledAlpha = a.getFloat(R.styleable.VerticalTheme_android_disabledAlpha, 0.5f);
        a.recycle();
    }
