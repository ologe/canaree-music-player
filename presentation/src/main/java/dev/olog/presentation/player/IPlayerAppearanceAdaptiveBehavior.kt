    ...
    override fun invoke(viewHolder: DataBoundViewHolder, viewModel: PlayerFragmentViewModel) {
        ...
        viewModel.observePaletteColors()
            ...
            .subscribe(viewHolder) { accent ->
                ...
                view.findViewById<ShuffleButton>(R.id.shuffle).updateSelectedColor(accent)
                view.findViewById<RepeatButton>(R.id.repeat).updateSelectedColor(accent)
                view.findViewById<CustomSeekBar>(R.id.seekBar).apply {
    ...
    override fun invoke(viewHolder: DataBoundViewHolder, viewModel: PlayerFragmentViewModel) {
        ...
        viewModel.observePaletteColors()
            ...
            .subscribe(viewHolder) { accent ->
                ...
                view.findViewById<View>(R.id.playPause).backgroundTintList = ColorStateList.valueOf(accent)
                view.findViewById<ShuffleButton>(R.id.shuffle).updateSelectedColor(accent)
                view.findViewById<RepeatButton>(R.id.repeat).updateSelectedColor(accent)
            }
    }
    ...
    override fun invoke(viewHolder: DataBoundViewHolder, viewModel: PlayerFragmentViewModel) {
        ...
        viewModel.observePaletteColors()
            ...
            .subscribe(viewHolder) { accent ->
                ...
                view.findViewById<ImageView>(R.id.more).imageTintList = ColorStateList.valueOf(accent)
                view.findViewById<ImageView>(R.id.lyrics).imageTintList = ColorStateList.valueOf(accent)
            }
    }
}
