package dev.olog.presentation.fragment_equalizer.widget;
 ...
 */
public class InfiniteInkPageIndicator extends View implements ViewPager.OnPageChangeListener,
    ...
    public InfiniteInkPageIndicator(Context context) {
        this(context, null, 0);
    }

    public InfiniteInkPageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public InfiniteInkPageIndicator(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setViewPager(InfiniteViewPager viewPager) {
        ...
        setPageCount(viewPager.getAdapter().getRealCount());
        viewPager.getAdapter().registerDataSetObserver(new DataSetObserver() {
            @Override
            public void onChanged() {
                setPageCount(InfiniteInkPageIndicator.this.viewPager.getAdapter().getRealCount());
            }
        });
    ...
    public void onPageSelected(int position) {
        if (isAttachedToWindow) {
            ...
            position = position % (viewPager.getAdapter().getRealCount());
