...
object AppTheme {
    ...
    enum class Theme {
        DEFAULT, FLAT, SPOTIFY, FULLSCREEN, BIG_IMAGE, PLAIN;
    }
    ...
    fun isPlain(): Boolean = THEME == Theme.PLAIN
    ...
    private fun getTheme(context: Context): Theme {
        ...
        return when (theme) {
            ...
            context.getString(R.string.prefs_appearance_entry_value_plain) -> Theme.PLAIN
