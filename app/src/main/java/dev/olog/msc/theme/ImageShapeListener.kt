...
internal class ImageShapeListener @Inject constructor(
...
) : BaseThemeUpdater<ImageShape>(context, prefs, context.getString(dev.olog.feature.settings.api.R.string.prefs_icon_shape_key)) {
    ...
    override fun getValue(): ImageShape {
        val value = prefs.getString(key, context.getString(dev.olog.feature.settings.api.R.string.prefs_icon_shape_rounded))
