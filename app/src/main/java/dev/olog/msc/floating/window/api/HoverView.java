 ...
 */
package dev.olog.msc.floating.window.api;
...
import dev.olog.msc.floating.window.api.view.InViewDragger;
import dev.olog.msc.floating.window.api.window.InWindowDragger;
import dev.olog.msc.floating.window.api.window.WindowViewController;

import static dev.olog.msc.floating.window.api.SideDock.SidePosition.LEFT;
