...
class PlayNextDialog : BaseDialog() {
    ...
    private fun successMessage(): String {
        return when (mediaId) {
            is MediaId.Category -> resources.getQuantityString(R.plurals.xx_songs_added_to_play_next, listSize, listSize)
            is MediaId.Track -> getString(R.string.song_x_added_to_play_next, title)
        }
    }
    ...
    private fun createMessage() : String {
        return when (mediaId) {
            is MediaId.Category -> resources.getQuantityString(R.plurals.add_xx_songs_to_play_next, listSize, listSize)
            // TODO add podcast localization
            is MediaId.Track -> getString(R.string.add_song_x_to_play_next, title)
        }
    }
