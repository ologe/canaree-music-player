...
class EditTrackFragment : BaseEditItemFragment() {
    ...
    private suspend fun trySave() {
        ...
        when (result) {
            ...
            UpdateResult.EMPTY_TITLE -> ctx.toast(localization.R.string.edit_song_invalid_title)
            UpdateResult.ILLEGAL_DISC_NUMBER -> ctx.toast(localization.R.string.edit_song_invalid_disc_number)
            UpdateResult.ILLEGAL_TRACK_NUMBER -> ctx.toast(localization.R.string.edit_song_invalid_track_number)
            UpdateResult.ILLEGAL_YEAR -> ctx.toast(localization.R.string.edit_song_invalid_year)
        }
    }
