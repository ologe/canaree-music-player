...
internal class AppPreferencesGatewayImpl @Inject constructor(
    ...
    override val isFirstAccess: Boolean
        get() {
    ...
    override val isAdaptiveColorEnabled: Boolean
        get() = preferences.getBoolean(context.getString(R.string.prefs_adaptive_colors_key), false)

    override val canShowPodcasts: Boolean
        get() = preferences.getBoolean(context.getString(R.string.prefs_show_podcasts_key), true)
