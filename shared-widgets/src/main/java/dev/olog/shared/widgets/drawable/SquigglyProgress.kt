 ...
 *
 * https://cs.android.com/android/platform/superproject/main/+/main:frameworks/base/packages/SystemUI/src/com/android/systemui/media/controls/ui/drawable/SquigglyProgress.kt
 */

package dev.olog.shared.widgets.drawable
...
import dev.olog.shared.widgets.Interpolators
import dev.olog.shared.widgets.MathUtils
    ...
    override fun draw(canvas: Canvas) {
            ...
            totalWidth *
                    (if (!transitionEnabled || progress > matchedWaveEndpoint) progress
                        ...
                        MathUtils.lerp(
                            minWaveEndpoint,
                            matchedWaveEndpoint,
                            MathUtils.lerpInv(0f, matchedWaveEndpoint, progress)
                        ))
        ...
        val computeAmplitude: (Float, Float) -> Float = { x, sign ->
            if (transitionEnabled) {
                ...
                val coeff =
                    MathUtils.lerpInvSat(waveProgressPx + length / 2f, waveProgressPx - length / 2f, x)
