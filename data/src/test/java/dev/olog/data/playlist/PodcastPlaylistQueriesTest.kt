...
class PodcastPlaylistQueriesTest {
    ...
    fun setup() {
        ...
        indexedPlayableQueries.insert(IndexedPlayables(1L, is_podcast = true))
        indexedPlayableQueries.insert(IndexedPlayables(2L, is_podcast = true))
        indexedPlayableQueries.insert(IndexedPlayables(3L, is_podcast = true))
        indexedPlayableQueries.insert(IndexedPlayables(4L, is_podcast = true))
        // 5 missing
        indexedPlayableQueries.insert(IndexedPlayables(6, is_podcast = true))

        indexedPlayableQueries.insert(IndexedPlayables(7, is_podcast = true, directory = "dir"))
    }
