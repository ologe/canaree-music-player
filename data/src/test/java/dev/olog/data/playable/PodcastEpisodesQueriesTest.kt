...
class PodcastEpisodesQueriesTest {
    ...
    fun `test selectAll, should return non blacklisted and non podcast`() {
        ...
        val expected = listOf(
            IndexedTrack(id = "1", is_podcast = true, directory = "no"),
            IndexedTrack(id = "2", is_podcast = true, directory = "no")
        )
    ...
    @Test
    fun `test selectById`() {
        val song = IndexedTrack(id = "1", is_podcast = true)
    ...
    fun `test selectByCollectionId`() {
        val song = IndexedTrack(id = "1", collection_id = "2", is_podcast = true)
        indexedQueries.insert(song)
    ...
    fun `test selectByCollectionId, should be null when item is missing`() {
        val song = IndexedTrack(id = "1", collection_id = "3", is_podcast = true)
        indexedQueries.insert(song)
