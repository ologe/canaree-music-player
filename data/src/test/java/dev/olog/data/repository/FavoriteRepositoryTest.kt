...
internal class FavoriteRepositoryTest {
    ...
    fun `should update state`() = coroutinesRule.runBlockingTest {
        // given
        val state = dev.olog.domain.entity.favorite.FavoriteItemState(1, FavoriteState.FAVORITE, FavoriteTrackType.TRACK)
        sut.getState()
    ...
    fun `should add single track and update favorite state`() = coroutinesRule.runBlockingTest {
        ...
        sut.updateFavoriteState(
            dev.olog.domain.entity.favorite.FavoriteItemState(
                id,
        ...
        verify(dao).insertOneImpl(FavoriteEntity(id))
        assertEquals(
            dev.olog.domain.entity.favorite.FavoriteItemState(id, FavoriteState.FAVORITE, FavoriteTrackType.TRACK),
            sut.getState()
        )
        verifyNoMoreInteractions(dao)
    }
    ...
    fun `should add single podcast and update favorite state`() = coroutinesRule.runBlockingTest {
        ...
        assertEquals(
            dev.olog.domain.entity.favorite.FavoriteItemState(id, FavoriteState.FAVORITE, FavoriteTrackType.PODCAST),
            sut.getState()
        )
        verifyNoMoreInteractions(dao)
    }
    ...
    fun `should delete single track and update favorite state`() = coroutinesRule.runBlockingTest {
        // given
        val id = 1L
        sut.updateFavoriteState(dev.olog.domain.entity.favorite.FavoriteItemState(id, FavoriteState.FAVORITE, FavoriteTrackType.TRACK))
        ...
        assertEquals(
            dev.olog.domain.entity.favorite.FavoriteItemState(id, FavoriteState.NOT_FAVORITE, FavoriteTrackType.TRACK),
            sut.getState()
        )
        verifyNoMoreInteractions(dao)
    }
    ...
    fun `should delete single podcast and update favorite state`() = coroutinesRule.runBlockingTest {
        ...
        assertEquals(
            dev.olog.domain.entity.favorite.FavoriteItemState(id, FavoriteState.NOT_FAVORITE, FavoriteTrackType.PODCAST),
            sut.getState()
        )
        verifyNoMoreInteractions(dao)
    }
