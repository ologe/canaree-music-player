...
import dev.olog.data.PodcastCollectionView
...
class PodcastCollectionQueriesTest {
    ...
    fun setup() {
        ...
        indexedQueries.insert(IndexedPlayables(id = 100, collection_id = 10, is_podcast = true))
        indexedQueries.insert(IndexedPlayables(id = 101, collection_id = 10, is_podcast = true))
        indexedQueries.insert(IndexedPlayables(id = 102, collection_id = 10, is_podcast = true))
        indexedQueries.insert(IndexedPlayables(id = 103, collection_id = 20, is_podcast = true))
        indexedQueries.insert(IndexedPlayables(id = 104, collection_id = 20, is_podcast = true))
        // below should be filtered
        indexedQueries.insert(IndexedPlayables(id = 105, collection_id = 30, is_podcast = false))
        indexedQueries.insert(IndexedPlayables(id = 106, collection_id = 30, is_podcast = true, directory = "dir"))
    }
    ...
    fun `test lastPlayed, max 10 items`() {
        indexedQueries.insert(IndexedPlayables(id = 1, collection_id = 1, is_podcast = true))
        indexedQueries.insert(IndexedPlayables(id = 2, collection_id = 2, is_podcast = true))
        indexedQueries.insert(IndexedPlayables(id = 3, collection_id = 3, is_podcast = true))
        indexedQueries.insert(IndexedPlayables(id = 4, collection_id = 4, is_podcast = true))
        indexedQueries.insert(IndexedPlayables(id = 5, collection_id = 5, is_podcast = true))
        indexedQueries.insert(IndexedPlayables(id = 6, collection_id = 6, is_podcast = true))
        indexedQueries.insert(IndexedPlayables(id = 7, collection_id = 7, is_podcast = true))
        indexedQueries.insert(IndexedPlayables(id = 8, collection_id = 8, is_podcast = true))
        indexedQueries.insert(IndexedPlayables(id = 9, collection_id = 9, is_podcast = true))
        indexedQueries.insert(IndexedPlayables(id = 10, collection_id = 10, is_podcast = true))
        indexedQueries.insert(IndexedPlayables(id = 11, collection_id = 11, is_podcast = true))
        indexedQueries.insert(IndexedPlayables(id = 12, collection_id = 12, is_podcast = true))
        indexedQueries.insert(IndexedPlayables(id = 13, collection_id = 12, is_podcast = true))
