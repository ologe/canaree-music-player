...
class MediaStorePodcastsViewDaoTest : MediaStoreTest(isPodcastTest = true) {

    private val mediaStoreDao = db.mediaStoreAudioDao()
    private val sortRepository = SortRepository(db.sortDao())
    private val sut = db.mediaStorePodcastDao()
    ...
    fun testGetAllSortedByTitleAsc() = runTest {
        sortRepository.setAllPodcastsSort(AllPodcastsSort(PodcastSortType.Title, SortDirection.ASCENDING))
        mediaStoreDao.insertAll(TestData.items(true))
    ...
    fun testGetAllSortedByTitleDesc() = runTest {
        sortRepository.setAllPodcastsSort(AllPodcastsSort(PodcastSortType.Title, SortDirection.DESCENDING))
        mediaStoreDao.insertAll(TestData.items(true))
    ...
    fun testGetAllSortedByArtistAsc() = runTest {
        sortRepository.setAllPodcastsSort(AllPodcastsSort(PodcastSortType.Artist, SortDirection.ASCENDING))
        mediaStoreDao.insertAll(TestData.items(true))
    ...
    fun testGetAllSortedByArtistDesc() = runTest {
        sortRepository.setAllPodcastsSort(AllPodcastsSort(PodcastSortType.Artist, SortDirection.DESCENDING))
        mediaStoreDao.insertAll(TestData.items(true))
    ...
    fun testGetAllSortedByAlbumAsc() = runTest {
        sortRepository.setAllPodcastsSort(AllPodcastsSort(PodcastSortType.Album, SortDirection.ASCENDING))
        mediaStoreDao.insertAll(TestData.items(true))
    ...
    fun testGetAllSortedByAlbumDesc() = runTest {
        sortRepository.setAllPodcastsSort(AllPodcastsSort(PodcastSortType.Album, SortDirection.DESCENDING))
        mediaStoreDao.insertAll(TestData.items(true))
    ...
    fun testGetAllSortedByDurationAsc() = runTest {
        sortRepository.setAllPodcastsSort(AllPodcastsSort(PodcastSortType.Duration, SortDirection.ASCENDING))
        mediaStoreDao.insertAll(TestData.items(true))
    ...
    fun testGetAllSortedByDurationDesc() = runTest {
        sortRepository.setAllPodcastsSort(AllPodcastsSort(PodcastSortType.Duration, SortDirection.DESCENDING))
        mediaStoreDao.insertAll(TestData.items(true))
    ...
    fun testGetAllSortedByDateAsc() = runTest {
        sortRepository.setAllPodcastsSort(AllPodcastsSort(PodcastSortType.Date, SortDirection.ASCENDING))
        mediaStoreDao.insertAll(TestData.items(true))
    ...
    fun testGetAllSortedByDateDesc() = runTest {
        sortRepository.setAllPodcastsSort(AllPodcastsSort(PodcastSortType.Date, SortDirection.DESCENDING))
        mediaStoreDao.insertAll(TestData.items(true))
