...
class SortedPodcastCollectionQueriesTest {
    ...
    fun testSelectAllSortedByTitle() {
        ...
        val items = listOf(
            IndexedTrack(id = "1", collection_id = "1", collection = "abc", author = "abc2", is_podcast = true),
            IndexedTrack(id = "2", collection_id = "1", collection = "abc", author = "abc2", is_podcast = true),
            IndexedTrack(id = "3", collection_id = "2", collection = "äaa", author = "äaa2", is_podcast = true),
            IndexedTrack(id = "4", collection_id = "3", collection = "<unknown>", author = "<unknown>", is_podcast = true),
            IndexedTrack(id = "5", collection_id = "4", collection = "zzz", author = "zzz2", is_podcast = true),
            // filtered
            IndexedTrack(id = "100", collection_id = "1000", is_podcast = true, directory = "dir"),
        )
    ...
    fun testSelectArtistAlbums() {
        val items = listOf(
            IndexedTrack(id = "10000", is_podcast = true, author_id = "123", collection_id = "1", collection = "abc"),
            IndexedTrack(id = "10001", is_podcast = true, author_id = "123", collection_id = "2", collection = "def"),
            IndexedTrack(id = "10002", is_podcast = true, author_id = "123", collection_id = "3", collection = "def"),
        )
        indexedQueries.insertGroup(items)
