...
class SortedPodcastAuthorQueriesTest {
    ...
    fun testSelectAllSortedByName() {
        ...
        // test ascending
        sortQueries.setPodcastAuthorsSort(Sort(AuthorSort.Name, SortDirection.ASCENDING))
        ...
        // test descending
        sortQueries.setPodcastAuthorsSort(Sort(AuthorSort.Name, SortDirection.DESCENDING))
