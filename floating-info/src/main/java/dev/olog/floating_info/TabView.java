...
public class TabView extends View {
    ...
    public TabView(Context context, @DrawableRes int backgroundDrawable, @DrawableRes int iconDrawable) {
        super(context);
        mCircleDrawable = ContextCompat.getDrawable(context, backgroundDrawable);
